...
def after_install(options, home_dir):
    subprocess.call([join(home_dir, 'bin', 'pip'),
                     'install', 'ipython', 'vanda', 'vakhshour', 'daarmaan', 'mimeparse', 'python-dateutil', 'lxml', 'pyyaml', 'uuid', 'django-tastypie', 'markdown', 'pygment', 'django-tagging', 'django-robots', 'feedparser' ])
